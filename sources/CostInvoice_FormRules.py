...
FORM_RULES = {
    ...
    "rodzaj_fv_obj": { "type": "union<rodzaj_fv>", "required": False, "visibleIf": {'source': 'EXPECTED_VALUE'}, "label": "Typ transakcji" },
    "transaction_items": { "type": "list<union<vat_category>>", "required": False, "visibleIf": {'source': 'EXPECTED_VALUE'}, "label": "Pozycje księgowania" },
}
